			...
			<nav className={styles.navbar}>
				<ul className={styles.navbar_nav}>
					...
					<li className={styles.nav_item}>
						...
						<span className={styles.link_text}>ESTOQUE</span>
					</li>
					...
					<li className={styles.nav_item}>
						<div className={styles.nav_link}>
							...
							<span className={styles.link_text}>Create</span>
						</div>
					</li>
					<li className={styles.nav_item}>
						<a href="/invoices" className={styles.nav_link}>
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="24"
								height="24"
							...
							<span className={styles.link_text}>Invoices</span>
						</a>
					</li>
					<li className={styles.nav_item}>
						<div className={styles.nav_link}>
